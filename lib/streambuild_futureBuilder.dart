...
class StreamFutureBuilder extends StatefulWidget {
  @override
  _StreamFutureBuilderState createState() => _StreamFutureBuilderState();
}

class _StreamFutureBuilderState extends State<StreamFutureBuilder> {
