...
import 'package:swipedeletepullrefresh_demo/movie_list/movie_detailspage.dart';
import 'package:swipedeletepullrefresh_demo/movie_list/movie_modal.dart';
                  ...
                  return Center(
                    child: InkWell(
                      ...
                      onTap: () {
                        ...
                        this.widget.callBack.viewType(
                            MovieDetailsPage(id, list), "movie_detailsPage");
                      },
                    ),
                  );
                })),
